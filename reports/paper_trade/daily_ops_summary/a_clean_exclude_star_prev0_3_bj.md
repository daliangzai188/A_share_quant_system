...
|-------------:|-----------:|------------------------:|-----------------------:|:------------------------------|------------------------------:|------------------------:|--------------------------:|-------------------------------:|-----------------------------------:|----------------------------:|----------------------------:|-----------:|---------------------:|------------------------:|-------------:|-----------:|-----------------:|---------------:|------------------:|---------------:|:---------------------|:------------------------------|
|     20251219 |   20260417 |                       2 |                     20 | False                         |                             1 |                       1 |                         0 |                              0 |                                  1 |                           1 |                           2 |          1 |            0.0352808 |               0.0352808 |    0.0352808 |  0.0352808 |           500000 |         517640 |           1.03528 |              0 | False                | INSUFFICIENT_OBSERVATION_DAYS |

## 状态分布

| operation_status          |   day_count |
|:--------------------------|------------:|
| HISTORICAL_SIM_FILLED     |           1 |
| REVIEW_REQUIRED_PLAN_ONLY |           1 |

## 每日明细

|   signal_date | operation_status          | top_ts_code   | top_name   | manual_review_required   |   planned_order_count |   account_return | risk_flags         |
|--------------:|:--------------------------|:--------------|:-----------|:-------------------------|----------------------:|-----------------:|:-------------------|
|      20251219 | REVIEW_REQUIRED_PLAN_ONLY | 300557.SZ     | 理工光科       | True                     |                     1 |       -0.10726   | LOSS_OVERLAY_WATCH |
|      20260417 | HISTORICAL_SIM_FILLED     | 301319.SZ     | 唯特偶        | False                    |                     1 |        0.0352808 | 无                  |
...
|      20260417 | HISTORICAL_SIM_FILLED     | 301319.SZ | 唯特偶    |        0.0352808 |   517640 |        517640 |          0 |
