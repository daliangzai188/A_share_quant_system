...
> 当前四腿严格研究回放为135笔、1213.664995倍；A已切换为`A_FD_EXPANSION_20260630_V1`（封单比例0.3%-1%两分支OR），A独立63笔、18.911549倍；C仍为`C_LEADER_UNION_20260630_V1`。协议仍为`STRICT_DISCOVERY`，机械复利不是收益承诺，容量尚未认证。
