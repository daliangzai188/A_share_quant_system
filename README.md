...
> 当前四腿严格研究回放为134笔、1375.623853倍；E已新增一日成交额倍率，与换手率做50%/50%日内分位评分；A为`A_FD_EXPANSION_20260630_V1`，C为`C_LEADER_UNION_20260630_V1`。协议仍为`STRICT_DISCOVERY`，机械复利不是收益承诺，容量尚未认证。
...
1. 不每天改策略。
2. A、C各自独立生成候选；最终单账户资金按D>A>E>C统一裁决，B不再参与。
