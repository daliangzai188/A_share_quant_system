...
> 接力，把该常量改回实际笔数即可恢复。研究腿序为 **D>L>A>M>E2>C**；M当前关闭
> 真实下单，因此实盘标尺为135笔/7677.946823倍/-23.51%。
...
5. 替换D退出价后，完整135笔组合复利不低于7677.946823倍；
6. 完整组合最大回撤不劣于-23.512441%；
...
> （该对比完成后又做了M成交口径对齐；2026-08-10因M未通过分段回撤非劣门禁，
> 当前实盘标尺回到不含M的135笔/7677.946823倍/-23.51%。接力全关结论不受影响。）
>
