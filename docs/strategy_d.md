...
> 接力，把该常量改回实际笔数即可恢复。同期腿序重排为 **D>L>A>M>E2>C**，组合标尺
> 150笔/29387.054989倍/-23.56%。
...
5. 替换D退出价后，完整135笔组合复利不低于7677.219011倍；
6. 完整组合最大回撤不劣于-23.504963%；
...
> （该对比完成后同日又做了 M 成交口径对齐，当前标尺为 150笔/29387.054989倍/-23.56%；
> 接力全关的结论不受影响，两侧是同口径比较。）
>
