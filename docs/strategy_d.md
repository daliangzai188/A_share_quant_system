...
本轮逐派研究D1竞价抢筹、D2开盘冲板、D3 7%～9%半路、D4首次封板、
D5炸板低吸，并把所有通过候选与当前D6按信号先后和真实占仓互斥合并。门禁固定为：
Dx独立至少20笔且复利大于1、合并D复利高于2.0261239236倍、ACDE复利高于
...
最终不存在可与D6合并的Dx，正式D保持现行D6：39笔、2.0261239236倍、
