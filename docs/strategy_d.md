...
> 接力，把该常量改回实际笔数即可恢复。当前腿序为 **D>A>M>E>C**；M按用户明确
> 风险接受恢复真实下单，当前标尺为145笔/2992.901872倍/-23.51%。
...
5. 替换D退出价后，完整145笔组合复利不低于2992.901872倍；
6. 完整组合最大回撤不劣于-23.506229%；
7. 同时查看成交均价代理和bar最低价压力代理，不能只看乐观结果。

> **2026-08-19基准纠正**：当前唯一口径为D>A>M>E>C，普通D为17笔；D认证输入
...
> 当前发布标尺必须以`reports/current_portfolio_alignment`的D>A>M>E>C认证为准。
...
> 当前正式标尺为145笔/2992.901872倍/-23.5062%。
> 接力全关结论不受影响。）
>
