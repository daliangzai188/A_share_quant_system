...
组合胜率68.21%、平均账户收益5.68%、中位数2.61%、最大回撤-22.39%、固定初始本金
累计口径10.83倍。机械满额复投为5813.315346倍，但容量未认证，不能作为实盘收益预期。
...
> 风险接受进入真实下单，当前v3标尺为173笔/5813.315346倍/-22.39%。
...
5. 替换D退出价后，完整173笔组合复利不低于5813.315346倍；
...
> 2026-08-20按N v3修复后，当前正式标尺为173笔/5813.315346倍/-22.3862%；
