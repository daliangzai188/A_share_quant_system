...
组合胜率67.10%、平均账户收益6.54%、中位数3.69%、最大回撤-22.48%、固定初始本金
累计口径11.13倍。机械满额复投为7108.624210倍，但容量未认证，不能作为实盘收益预期。
...
> 风险接受进入真实下单，当前标尺为155笔/7108.624210倍/-22.48%。
...
5. 替换D退出价后，完整155笔组合复利不低于7108.624210倍；
6. 完整组合最大回撤不劣于-22.480569%；
7. 同时查看成交均价代理和bar最低价压力代理，不能只看乐观结果。

> **2026-08-19基准纠正**：当前唯一口径为D>A>M>E>C>N，普通D为17笔；D认证输入
...
> 当前正式标尺为155笔/7108.624210倍/-22.4806%。
> 接力全关结论不受影响。）
>
