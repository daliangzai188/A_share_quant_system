...
组合胜率66.09%、平均账户收益6.01%、中位数2.68%、最大回撤-22.48%、固定初始本金
累计口径11.45倍。机械满额复投为9508.426795倍，但容量未认证，不能作为实盘收益预期。
...
> 风险接受进入真实下单，当前标尺为174笔/9508.426795倍/-22.48%。
...
5. 替换D退出价后，完整174笔组合复利不低于9508.426795倍；
6. 完整组合最大回撤不劣于-22.480569%；
...
> 当前正式标尺为174笔/9508.426795倍/-22.4806%。
> 接力全关结论不受影响。）
>
