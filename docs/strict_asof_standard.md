...
当前A>C>E>D真实开仓日两年锚点：`20240630~20260630`（首个可用信号日
为2024-07-01）。其它旧窗口只能作历史来源说明，不得进入当前候选比较。

组合认证不得把四腿都压在信号日排序。A/C/E是T日收盘后计划、T+1开盘执行；
D是操作日盘中策略。正式回放先把候选映射到真实`action_date`，按A、C、E选择
上一交易日计划，三腿均无计划时才允许D；退出日收盘后才释放资金。
